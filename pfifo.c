...
//semaphore to control the producerss
sem_t *index_sem; 
//semaphore to control consumers
sem_t *consumer_sem;

long *totalJobs;
int shmid, shmid1, shmid2, shmid3, shmid4, shmid5, shmid6;
long totalwaitTime;
int numOfConsumers;
pthread_t *thread;
...
int main(int argc, char **argv) {
    ...
    *writeIndex = 0;
    ...
    shmid6 = shmget(IPC_PRIVATE, sizeof(sem_t), IPC_CREAT | 0666);
    consumer_sem = (sem_t*)shmat(shmid6, NULL, 0);
